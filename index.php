      ...
      <div class="container">
        ...
        <div class="row justify-content-center fs-5 text-center">
          <div class="col-md-4" data-aos="fade-right">
            <p>Gipay adalah layanan dompet digital yang dikembangkan oleh FINTECH FINFUN. GIPay memungkinkan pengguna untuk melakukan berbagai transaksi secara elektronik tanpa memerlukan uang tunai.</p>
          </div>
          <div class="col-md-4" data-aos="fade-left">
            <p>GIPay mudah diakses dan digunakan oleh jutaan pengguna di DUNIA. Dompet digital ini juga terus berkembang dengan menambahkan fitur-fitur baru untuk memudahkan transaksi sehari-hari.</p>
          </div>
        </div>
      </div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
