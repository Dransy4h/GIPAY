...
<head>
    ...
    .container-fluid{
      padding-top: ;
      padding-bottom: ;
      background-image: url(assets/img/bg.jp);
      height:
    }  
    .a{
      color: #D853DC; 
...
<body class="bg-img">
<div class="card">
  <div class="card-header  fixed-to bg-info border border-3 rounded-3 ">
   <div class="row">
      <div class="col-3">
        <a class="nav-link active px-5 py-2" href="index.php">
          <img src="assets/img/logo.png" class="clickable" alt="GIPAY" style="width: 150px;">
        </a>
      </div>
      <div class="col-9">
   <ul class="nav justify-content-end container">
    
    <li class="nav-item dropdown btn btn-outline-primary border border-2 border-primary rounded-circle">
